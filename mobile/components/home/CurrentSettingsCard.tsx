  ...
  return (
    <View style={styles.card}>
      <View style={styles.header}>
        <FontAwesome name="line-chart" size={18} color={appTheme.colors.accent} />
        <Text style={styles.headerTitle}>Current Settings</Text>
      </View>
      <View style={styles.list}>
        <Row icon="clock-o" title="Next Alarm" subtitle={nextAlarmLine} />
        <Row icon="music" title="Active Sound" subtitle={activeSoundLine} />
        <Row icon="moon-o" title="Night Mode" subtitle={nightModeLine} />
      </View>
    </View>
  );
}
