    ...
    <View style={styles.card}>
      ...
      <View style={styles.grid}>
        <View style={styles.gridRow}>
          <Metric label="Total Duration" value="7h 42m" large />
          <Metric label="Sleep Quality" value="92%" valueAccent large />
        </View>
        <View style={styles.gridRow}>
          <Metric label="Deep Sleep" value="2h 15m" />
          <Metric label="REM Sleep" value="1h 48m" />
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  metricValueAccent: { color: appTheme.colors.accent },
  insight: {
